  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: 'var(--radius)', width: 380,
        boxShadow: 'var(--shadow)', border: '1px solid var(--border)'
      }}>
        <div style={{ fontFamily: 'Bebas Neue', fontSize: 32, marginBottom: 4 }}>2Pumped</div>
        <div style={{ fontSize: 13, color: 'var(--text2)', marginBottom: 24 }}>Sign in to your account</div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input
            style={{ width: '100%', padding: '10px 14px', border: '1px solid var(--border)', borderRadius: 8, fontSize: 13, fontFamily: 'DM Sans' }}
            value={form.username}
        ...
        <div style={{ textAlign: 'center', marginTop: 16, fontSize: 13, color: 'var(--text2)' }}>
          ...
          <span style={{ color: 'var(--accent)', cursor: 'pointer' }} onClick={() => navigate('/register')}>
            Register
          </span>
        </div>
      </div>
